  ...
  return (
    <section className=" p-4 outline outline-black">
      ...
      <div className="flex flex-col gap-8">
        ...
        <article>
          {/*  <image alt="project 2 image placeholder">
          Project 2 image placeholder
        </image> */}
          <div className="outline-grey flex flex-col flex-nowrap content-center gap-4 p-6 outline">
            <p className="text-center ">
              Project description Project description Project description
              Project description Project description
            </p>
            <div className="flex items-center justify-center gap-4 ">
              <h3 className="text-center text-lg">Project 2 </h3>
              <a
